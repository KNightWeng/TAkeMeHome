...
public class PageIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private IndicatorType mIndicatorType = IndicatorType.of(INDICATOR_TYPE_FRACTION);
    ...
    public void setViewPagerAndPosition(ViewPager pager, int position) {
        mViewPager = pager;
    ...
    private void updateIndicator(int position) {
        Log.d("PageIndicator", "updateIndicator(position) = " + position);
